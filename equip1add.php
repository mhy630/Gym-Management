...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $conn->prepare("INSERT INTO equipment1 (equipment_id, equipment_weight, quantity, purchase_date, purchase_cost) VALUES (?, ?, ?, ?, ?)");
  $stmt->bind_param("sssss", $equipment_id, $equipment_weight, $quantity, $purchase_date, $purchase_cost);
    ...
    <div class="container-wrapper" style="background-image: url(back.jpeg); background-repeat: no-repeat;background-size: cover;">
      <div class="form-wrapper" style="text-align:center">
        ...
        <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
          <div class="form-row">
            <label for="equipment_weight">Equipment Weight:</label>
            <input type="number" name="equipment_weight" id="equipment_weight" required>
          </div>
          <div class="form-row">
