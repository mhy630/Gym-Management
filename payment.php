...
<a href="paymentadd.php" class="add-button"><button> Add <i class="fas fa-plus"></i></button></a>
<?php
// Check if the member was deleted
session_start();
if (isset($_SESSION['payment_deleted']) && $_SESSION['payment_deleted']) {
    echo "<p style='color: white; font-weight: bold; margin-top: 10px;'>Payment deleted successfully.</p>";
    unset($_SESSION['payment_deleted']); // Clear the session variable
}
?>
<table>
  <tr>
